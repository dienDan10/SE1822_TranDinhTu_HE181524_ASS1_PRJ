 ...
 * @author urekk
 */
@WebServlet(name="NewOrder", urlPatterns={"/new_order"})
public class NewOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<OrderItem> list = new OrderDAO().getAllOrderByStatus("Processing");
        ...
        request.getRequestDispatcher("new-order-page").forward(request, response);
    } 
