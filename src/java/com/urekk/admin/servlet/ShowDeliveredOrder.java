 ...
 * @author urekk
 */
@WebServlet(name="ShowDeliveredOrder", urlPatterns={"/show_deliver_order"})
public class ShowDeliveredOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<OrderItem> list = new OrderDAO().getAllOrderByStatus("Delivering");
        list.addAll(new OrderDAO().getAllOrderByStatus("Received"));
        ...
        request.getRequestDispatcher("deliver-order-page").forward(request, response);
    } 
